...
#        continue
    ...
    if in_ev == 1:
        if line.split()[0] == "#" and line.split()[1] == "14":
            ...
            P_Z_v.push_back(Ep*math.cos(theta))
            P_X_v.push_back(Ep*math.sin(theta)*math.cos(phi))
            P_Y_v.push_back(Ep*math.sin(theta)*math.sin(phi))
        else:    
